...
const AddJob = () => {
    ...
    const handleform = async e => {
        ...
        const salaryRange = parseFloat(form.salaryRange.value);
                ...
                <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
                    <aside className="relative block h-16 lg:order-last lg:col-span-5 lg:h-full xl:col-span-6">
                        <img
                            ...
                            src="https://images.unsplash.com/photo-1653669487177-d7c8e245f0f2?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80"
                    ...
                    >
                        <div className="max-w-xl lg:max-w-3xl">
                            ...
                            <p className="mt-4 leading-relaxed text-gray-500 dark:text-gray-400">
                                Are you looking to expand your team? Post your job listing here to reach a diverse pool of talented individuals ready to contribute to your organization's success.
                            </p>

                            <form onSubmit={handleform} className="mt-8 grid grid-cols-6 gap-6">
                                <div className="col-span-6">
                                    <label
                                        htmlFor="jobBannerUrl"
