            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
                    <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
                        <img
                            alt=""
                            src="https://images.unsplash.com/photo-1542626991-cbc4e32524cc?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80"
                        ...
                        <div className="hidden lg:relative lg:block lg:p-12">
                            <p className="block text-white" href="#">
                                ...
                                <img src="./JobHorizonCrop.png" className="size-20 object-cover rounded-full" alt="" />
                            </p>

                            <h2 className="mt-6 text-2xl font-bold text-white sm:text-3xl md:text-4xl">
                                Welcome to Job Horizon 💼
                            </h2>
                        ...
                        <div className="max-w-xl lg:max-w-3xl">
                            <div className="relative -mt-16 block lg:hidden">
                                ...
                                >
                                    ...
                                    <img src="./JobHorizonCrop.png" className="rounded-full" alt="" />
                                </p>
